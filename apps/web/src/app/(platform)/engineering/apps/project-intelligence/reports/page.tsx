    ...
    <section data-testid="reporting-intelligence-ready">
      <div data-testid="project-intelligence-reports-ready">
        ...
        <p className="mt-2 max-w-2xl text-slate-600">
          Project reports from recorded documents, meetings, and findings. Executive summaries are
          advisory and require human review before publish.
        </p>
        <p className="mt-3 text-sm font-medium text-slate-700" data-testid="pi-reports-scope">
          Scope: All Projects (workspace) unless a linked register surface honors the Engineering
        ...
        <div className="mt-8 rounded-lg border border-cyan-200 bg-cyan-50/40 p-5">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Configurable live widgets with drill-down to originating records. AI executive
            summaries use the existing Engineering AI runtime and require human review before
            publish. This dashboard is workspace-scoped unless a project filter is applied.
          </p>
          <Link
