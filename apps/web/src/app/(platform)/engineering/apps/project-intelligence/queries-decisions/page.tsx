  ...
  return (
    <section data-testid="project-intelligence-queries-decisions-ready">
      ...
      <p className="mt-2 max-w-3xl text-slate-600">
        Read-only interpretation of canonical Engineering OS technical queries, decisions, and
        actions. RFIs are not a separate register. This module does not answer queries, approve
        decisions, or close actions.
      </p>
      <div className="mt-8">
