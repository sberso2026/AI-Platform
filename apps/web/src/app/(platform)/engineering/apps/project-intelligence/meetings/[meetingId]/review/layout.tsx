...
export default function ProjectIntelligenceMeetingReviewLayout({
  children,
}: {
  ...
  return (
    <ApplicationEntitlementLayout
      policy={ENGINEERING_PAGE_POLICIES["/engineering/apps/project-intelligence/meetings/[meetingId]/review"]}
