/**
 * Phase 12H — Digital Twin simulation-packages HTTP API.
 */
...
const OPERATIONS = new Set(["create_package","seal_package","get_package","list_packages"]);
...
export async function POST(req: Request) {
  ...
  const operation = typeof body.operation === "string" ? body.operation : "create_package";
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    {
      requestId,
      result: "simulation-packages_lookup_ready",
      items: [],
      unexpected5xx: 0,
      ...ASSURANCE_GOVERNANCE,
    },
