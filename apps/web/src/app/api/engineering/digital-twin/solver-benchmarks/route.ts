/**
 * Phase 12I — Digital Twin solver-benchmarks HTTP API.
 */
...
const OPERATIONS = new Set(["list_benchmarks","run_benchmark","get_benchmark"]);
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    {
      requestId,
      result: "solver-benchmarks_lookup_ready",
      items: [],
      unexpected5xx: 0,
      ...ASSURANCE_GOVERNANCE,
    },
