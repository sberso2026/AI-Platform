/**
 * Phase 12H — Digital Twin simulation-eligibility HTTP API.
 */
...
const OPERATIONS = new Set(["assess_eligibility","get_eligibility"]);
...
export async function POST(req: Request) {
  ...
  const operation = typeof body.operation === "string" ? body.operation : "assess_eligibility";
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    {
      requestId,
      result: "simulation-eligibility_lookup_ready",
      items: [],
      unexpected5xx: 0,
      ...ASSURANCE_GOVERNANCE,
    },
