/**
 * Phase 12H — Digital Twin simulation-package-manifest HTTP API.
 */
...
const OPERATIONS = new Set(["get_manifest","put_manifest"]);
...
export async function POST(req: Request) {
  ...
  const operation = typeof body.operation === "string" ? body.operation : "get_manifest";
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    {
      requestId,
      result: "simulation-package-manifest_lookup_ready",
      items: [],
      unexpected5xx: 0,
      ...ASSURANCE_GOVERNANCE,
    },
