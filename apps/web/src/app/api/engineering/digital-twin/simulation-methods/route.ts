/**
 * Phase 12G — Digital Twin simulation-methods HTTP API.
 */
...
const OPERATIONS = new Set(["register_method", "get_method", "list_methods"]);
...
export async function POST(req: Request) {
  ...
  if (
    ...
    return err(
      422,
      "native_solver_payload_forbidden",
      "Native solver payloads are forbidden",
      requestId,
    );
  }
  const operation = typeof body.operation === "string" ? body.operation : "register_method";
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    {
      requestId,
      result: "simulation-methods_lookup_ready",
      items: [],
      ...GOVERNANCE,
    },
    { status: 200 },
