/**
 * Phase 12J — Digital Twin solver-capability-versions HTTP API.
 */
...
const OPERATIONS = new Set(["list_versions", "register_version", "get_version"]);
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    {
      requestId,
      result: "solver-capability-versions_lookup_ready",
      items: [],
      unexpected5xx: 0,
      ...ASSURANCE_GOVERNANCE,
    },
