/**
 * Phase 12I — Digital Twin solver-providers HTTP API.
 */
...
const OPERATIONS = new Set(["list_providers","register_provider","get_provider"]);
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    {
      requestId,
      result: "solver-providers_lookup_ready",
      items: [],
      unexpected5xx: 0,
      ...ASSURANCE_GOVERNANCE,
    },
