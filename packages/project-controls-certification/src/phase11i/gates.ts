/**
 * Phase 11I certification gates A–BC — Project Controls Scenario Intelligence.
 * 55 gates: A–Z (26) + AA–BC (29).
 */
export const PHASE_11I_PROJECT_CONTROLS_SCENARIO_GATES = [
  ...
  ["K", "Ownership locks"],
  ["L", "Scenario terminology"],
  ["M", "Project context composition"],
  ["N", "Scenario Control Context"],
  ["O", "Scenario Intelligence Engine"],
  ["P", "Scenario Intelligence State"],
  ["Q", "Scenario taxonomy governance"],
  ["R", "Composition layer governance"],
  ["S", "Scenario Evidence"],
  ["T", "Scenario Confidence"],
  ["U", "Scenario unit governance"],
  ...
  ["BC", "Phase 11J readiness"],
] as const;

export type Phase11iGateId = (typeof PHASE_11I_PROJECT_CONTROLS_SCENARIO_GATES)[number][0];

export const PHASE_11I_GATE_COUNT = PHASE_11I_PROJECT_CONTROLS_SCENARIO_GATES.length;

export const PHASE_11I_PROJECT_CONTROLS_VERSION = "0.9.0-scenario-intelligence" as const;
...
export const PHASE_11I_PROJECT_CONTROLS_SCENARIO_TABLES = [
...
export const PHASE_11I_PROJECT_CONTROLS_DECISION_TABLES = [
...
export const PHASE_11I_PROJECT_CONTROLS_PRODUCTIVITY_TABLES = [
...
export const PHASE_11I_PROJECT_CONTROLS_COST_TABLES = [
...
export const PHASE_11I_PROJECT_CONTROLS_CHANGE_TABLES = [
...
export const PHASE_11I_PROJECT_CONTROLS_SHARED_PROJECT_TABLES = [
  "project_controls_project_snapshots",
  "project_controls_project_timeline",
] as const;

export const PHASE_11I_PROJECT_CONTROLS_SCHEDULE_TABLES = [
...
export const PHASE_11I_PROJECT_CONTROLS_PROGRESS_TABLES = [
...
export const PHASE_11I_FORBIDDEN_WORKFORCE_TABLES = [
  "timesheets",
  "payroll",
...
export const PHASE_11I_FORBIDDEN_CAPABILITIES = [
...
export const PHASE_11I_REQUIRED_CAPABILITIES = [
...
export const PHASE_11I_SCENARIO_EVENTS = [
  "engineering.project.scenario.updated",
  "engineering.project.scenario.reviewed",
  "engineering.project.scenario.published",
] as const;

export const PHASE_11I_PROJECT_IDENTITY_OWNER = "engineering_os_shared_project_domain" as const;
export const PHASE_11I_SCENARIO_INTELLIGENCE_OWNER = "project_controls" as const;
export const PHASE_11I_FINANCIAL_LEDGER_OWNER = "external_finance_or_future_finance_domain" as const;
export const PHASE_11I_CONTRACTUAL_CHANGE_AUTHORITY_OWNER =
  "reserved_not_project_controls" as const;

// Aliases for certification runner compatibility
export const PHASE_11F_FINANCIAL_LEDGER_OWNER = PHASE_11I_FINANCIAL_LEDGER_OWNER;
export const PHASE_11F_PROJECT_IDENTITY_OWNER = PHASE_11I_PROJECT_IDENTITY_OWNER;
export const PHASE_11F_FORBIDDEN_CAPABILITIES = PHASE_11I_FORBIDDEN_CAPABILITIES;
export const PHASE_11F_FORBIDDEN_WORKFORCE_TABLES = PHASE_11I_FORBIDDEN_WORKFORCE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_COST_TABLES = PHASE_11I_PROJECT_CONTROLS_COST_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_CHANGE_TABLES = PHASE_11I_PROJECT_CONTROLS_CHANGE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_PROGRESS_TABLES = PHASE_11I_PROJECT_CONTROLS_PROGRESS_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_SCHEDULE_TABLES = PHASE_11I_PROJECT_CONTROLS_SCHEDULE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_SHARED_PROJECT_TABLES =
  PHASE_11I_PROJECT_CONTROLS_SHARED_PROJECT_TABLES;
