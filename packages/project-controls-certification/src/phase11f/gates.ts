/**
 * Phase 11F certification gates A–BC — Project Controls Productivity Intelligence.
 * 55 gates: A–Z (26) + AA–BC (29).
 *
 * Phase 11F proves Productivity Intelligence is implemented as advisory intelligence
 * while Progress (11B), Schedule (11C), Change (11D) and Cost (11E) Intelligence
 * stay intact.
 *
 ...
 */
export const PHASE_11F_PROJECT_CONTROLS_PRODUCTIVITY_GATES = [
  ...
  ["K", "Ownership locks"],
  ["L", "Productivity terminology"],
  ["M", "Workforce boundary"],
  ["N", "Productivity Control Context"],
  ["O", "Productivity Intelligence Engine"],
  ["P", "Productivity Intelligence State"],
  ["Q", "Productivity posture governance"],
  ["R", "Productivity factors governance"],
  ["S", "Productivity Evidence"],
  ["T", "Productivity Confidence"],
  ["U", "Execution unit governance"],
  ["V", "Reporting period/as-of governance"],
  ["W", "Productivity factor refs"],
  ...
  ["AF", "ProductivityProvider reserved"],
  ...
  ["AL", "Payroll forbidden"],
  ["AM", "Timesheet forbidden"],
  ...
  ["BC", "Phase 11G readiness"],
] as const;

export type Phase11fGateId = (typeof PHASE_11F_PROJECT_CONTROLS_PRODUCTIVITY_GATES)[number][0];

export const PHASE_11F_GATE_COUNT = PHASE_11F_PROJECT_CONTROLS_PRODUCTIVITY_GATES.length;

export const PHASE_11F_PROJECT_CONTROLS_VERSION = "0.6.0-productivity-intelligence" as const;
...
export const PHASE_11F_PROJECT_CONTROLS_PRODUCTIVITY_TABLES = [
...
export const PHASE_11F_REQUIRED_CAPABILITIES = [
  ...
  "PRODUCTIVITY_CONFIDENCE_ENGINE_READY",
  "PRODUCTIVITY_REVIEW_WORKFLOW_READY",
  "PRODUCTIVITY_PERSISTENCE_READY",
  "PRODUCTIVITY_INTELLIGENCE_IS_ADVISORY_ONLY",
  "PROJECT_TIMELINE_READY",
  "PROJECT_SNAPSHOT_READY",
  "AI_MAY_PUBLISH_PRODUCTIVITY_FORBIDDEN",
  "PHASE_11F_READY",
  "PHASE_11G_READY",
] as const;

export const PHASE_11F_PRODUCTIVITY_EVENTS = [
...
export const PHASE_11F_PRODUCTIVITY_INTELLIGENCE_OWNER = "project_controls" as const;
