/**
 * Phase 11J certification gates A–BC — Project Controls Scenario Intelligence.
 * 55 gates: A–Z (26) + AA–BC (29).
 */
export const PHASE_11J_PROJECT_CONTROLS_SCENARIO_GATES = [
  ...
  ["K", "Ownership locks"],
  ["L", "Risk/opportunity terminology"],
  ["M", "Project context composition"],
  ["N", "Risk/opportunity Control Context"],
  ["O", "Risk/opportunity Intelligence Engine"],
  ["P", "Risk/opportunity Intelligence State"],
  ["Q", "Risk/opportunity taxonomy governance"],
  ["R", "Composition layer governance"],
  ["S", "Risk/opportunity Evidence"],
  ["T", "Risk/opportunity Confidence"],
  ["U", "Risk/opportunity unit governance"],
  ...
  ["BC", "Phase 11K readiness"],
] as const;

export type Phase11jGateId = (typeof PHASE_11J_PROJECT_CONTROLS_SCENARIO_GATES)[number][0];

export const PHASE_11J_GATE_COUNT = PHASE_11J_PROJECT_CONTROLS_SCENARIO_GATES.length;

export const PHASE_11J_PROJECT_CONTROLS_VERSION = "0.10.0-risk-opportunity-intelligence" as const;
...
export const PHASE_11J_PROJECT_CONTROLS_SCENARIO_TABLES = [
...
export const PHASE_11J_PROJECT_CONTROLS_DECISION_TABLES = [
...
export const PHASE_11J_PROJECT_CONTROLS_PRODUCTIVITY_TABLES = [
...
export const PHASE_11J_PROJECT_CONTROLS_COST_TABLES = [
...
export const PHASE_11J_PROJECT_CONTROLS_CHANGE_TABLES = [
...
export const PHASE_11J_PROJECT_CONTROLS_SHARED_PROJECT_TABLES = [
  "project_controls_project_snapshots",
  "project_controls_project_timeline",
] as const;

export const PHASE_11J_PROJECT_CONTROLS_SCHEDULE_TABLES = [
...
export const PHASE_11J_PROJECT_CONTROLS_PROGRESS_TABLES = [
...
export const PHASE_11J_FORBIDDEN_WORKFORCE_TABLES = [
  "timesheets",
  "payroll",
...
export const PHASE_11J_FORBIDDEN_CAPABILITIES = [
...
export const PHASE_11J_REQUIRED_CAPABILITIES = [
  ...
  "RISK_OPPORTUNITY_CONFIDENCE_ENGINE_READY",
  "RISK_OPPORTUNITY_REVIEW_WORKFLOW_READY",
  "RISK_OPPORTUNITY_PERSISTENCE_READY",
  ...
  "AI_MAY_PUBLISH_RISK_OPPORTUNITY_FORBIDDEN",
...
export const PHASE_11J_SCENARIO_EVENTS = [
...
export const PHASE_11J_PROJECT_IDENTITY_OWNER = "engineering_os_shared_project_domain" as const;
export const PHASE_11J_SCENARIO_INTELLIGENCE_OWNER = "project_controls" as const;
export const PHASE_11J_FINANCIAL_LEDGER_OWNER = "external_finance_or_future_finance_domain" as const;
export const PHASE_11J_CONTRACTUAL_CHANGE_AUTHORITY_OWNER =
  "reserved_not_project_controls" as const;

// Aliases for certification runner compatibility
export const PHASE_11F_FINANCIAL_LEDGER_OWNER = PHASE_11J_FINANCIAL_LEDGER_OWNER;
export const PHASE_11F_PROJECT_IDENTITY_OWNER = PHASE_11J_PROJECT_IDENTITY_OWNER;
export const PHASE_11F_FORBIDDEN_CAPABILITIES = PHASE_11J_FORBIDDEN_CAPABILITIES;
export const PHASE_11F_FORBIDDEN_WORKFORCE_TABLES = PHASE_11J_FORBIDDEN_WORKFORCE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_COST_TABLES = PHASE_11J_PROJECT_CONTROLS_COST_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_CHANGE_TABLES = PHASE_11J_PROJECT_CONTROLS_CHANGE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_PROGRESS_TABLES = PHASE_11J_PROJECT_CONTROLS_PROGRESS_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_SCHEDULE_TABLES = PHASE_11J_PROJECT_CONTROLS_SCHEDULE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_SHARED_PROJECT_TABLES =
  PHASE_11J_PROJECT_CONTROLS_SHARED_PROJECT_TABLES;
