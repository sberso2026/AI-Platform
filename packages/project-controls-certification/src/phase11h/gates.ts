/**
 * Phase 11H certification gates A–BC — Project Controls Decision Support Intelligence.
 * 55 gates: A–Z (26) + AA–BC (29).
 *
 * Phase 11H proves Decision Support Intelligence is implemented as advisory intelligence
 ...
 * no decision engine, no earned value, no CPM, no schedule execution and no
 * duplicate project ownership.
 */
export const PHASE_11H_PROJECT_CONTROLS_DECISION_GATES = [
  ...
  ["K", "Ownership locks"],
  ["L", "Decision terminology"],
  ["M", "Project context composition"],
  ["N", "Decision Control Context"],
  ["O", "Decision Support Intelligence Engine"],
  ["P", "Decision Support Intelligence State"],
  ["Q", "Decision posture governance"],
  ["R", "Composition layer governance"],
  ["S", "Decision Evidence"],
  ["T", "Decision Confidence"],
  ["U", "Decision unit governance"],
  ...
  ["BC", "Phase 11I readiness"],
] as const;

export type Phase11hGateId = (typeof PHASE_11H_PROJECT_CONTROLS_DECISION_GATES)[number][0];

export const PHASE_11H_GATE_COUNT = PHASE_11H_PROJECT_CONTROLS_DECISION_GATES.length;

export const PHASE_11H_PROJECT_CONTROLS_VERSION = "0.8.0-decision-support" as const;
...
export const PHASE_11H_PROJECT_CONTROLS_DECISION_TABLES = [
...
export const PHASE_11H_PROJECT_CONTROLS_PRODUCTIVITY_TABLES = [
...
export const PHASE_11H_REQUIRED_CAPABILITIES = [
  ...
  "DECISION_CONFIDENCE_ENGINE_READY",
  "DECISION_REVIEW_WORKFLOW_READY",
  "DECISION_PERSISTENCE_READY",
  "DECISION_SUPPORT_IS_ADVISORY_ONLY",
  "FORECAST_INTELLIGENCE_IS_ADVISORY_ONLY",
  "PROJECT_TIMELINE_READY",
  "PROJECT_SNAPSHOT_READY",
  "AI_MAY_PUBLISH_DECISION_FORBIDDEN",
  "PHASE_11G_READY",
  "PHASE_11H_READY",
  "PHASE_11I_READY",
] as const;

export const PHASE_11H_DECISION_EVENTS = [
...
export const PHASE_11H_DECISION_SUPPORT_OWNER = "project_controls" as const;
