/**
 * Phase 11L certification gates A–BC — Project Controls Explainability Intelligence.
 * 55 gates: A–Z (26) + AA–BC (29).
 */
export const PHASE_11L_PROJECT_CONTROLS_SCENARIO_GATES = [
  ...
  ["K", "Ownership locks"],
  ["L", "Explainability terminology"],
  ["M", "Project context composition"],
  ["N", "Explainability Control Context"],
  ["O", "Explainability Intelligence Engine"],
  ["P", "Explainability Intelligence State"],
  ["Q", "Explainability taxonomy governance"],
  ["R", "Composition layer governance"],
  ["S", "Explainability Evidence"],
  ["T", "Explainability Confidence"],
  ["U", "Explainability unit governance"],
  ...
  ["BC", "Phase 11M readiness"],
] as const;

export type Phase11lGateId = (typeof PHASE_11L_PROJECT_CONTROLS_SCENARIO_GATES)[number][0];

export const PHASE_11L_GATE_COUNT = PHASE_11L_PROJECT_CONTROLS_SCENARIO_GATES.length;

export const PHASE_11L_PROJECT_CONTROLS_VERSION = "0.12.0-explainability-intelligence" as const;
...
export const PHASE_11L_PROJECT_CONTROLS_SCENARIO_TABLES = [
...
export const PHASE_11L_PROJECT_CONTROLS_DECISION_TABLES = [
...
export const PHASE_11L_PROJECT_CONTROLS_PRODUCTIVITY_TABLES = [
...
export const PHASE_11L_PROJECT_CONTROLS_COST_TABLES = [
...
export const PHASE_11L_PROJECT_CONTROLS_CHANGE_TABLES = [
...
export const PHASE_11L_PROJECT_CONTROLS_SHARED_PROJECT_TABLES = [
  "project_controls_project_snapshots",
  "project_controls_project_timeline",
] as const;

export const PHASE_11L_PROJECT_CONTROLS_SCHEDULE_TABLES = [
...
export const PHASE_11L_PROJECT_CONTROLS_PROGRESS_TABLES = [
...
export const PHASE_11L_FORBIDDEN_WORKFORCE_TABLES = [
  "timesheets",
  "payroll",
...
export const PHASE_11L_FORBIDDEN_CAPABILITIES = [
...
export const PHASE_11L_REQUIRED_CAPABILITIES = [
  ...
  "EXPLAINABILITY_CONFIDENCE_ENGINE_READY",
  "EXPLAINABILITY_REVIEW_WORKFLOW_READY",
  "EXPLAINABILITY_PERSISTENCE_READY",
...
export const PHASE_11L_SCENARIO_EVENTS = [
...
export const PHASE_11L_PROJECT_IDENTITY_OWNER = "engineering_os_shared_project_domain" as const;
export const PHASE_11L_SCENARIO_INTELLIGENCE_OWNER = "project_controls" as const;
export const PHASE_11L_FINANCIAL_LEDGER_OWNER = "external_finance_or_future_finance_domain" as const;
export const PHASE_11L_CONTRACTUAL_CHANGE_AUTHORITY_OWNER =
  "reserved_not_project_controls" as const;

// Aliases for certification runner compatibility
export const PHASE_11F_FINANCIAL_LEDGER_OWNER = PHASE_11L_FINANCIAL_LEDGER_OWNER;
export const PHASE_11F_PROJECT_IDENTITY_OWNER = PHASE_11L_PROJECT_IDENTITY_OWNER;
export const PHASE_11F_FORBIDDEN_CAPABILITIES = PHASE_11L_FORBIDDEN_CAPABILITIES;
export const PHASE_11F_FORBIDDEN_WORKFORCE_TABLES = PHASE_11L_FORBIDDEN_WORKFORCE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_COST_TABLES = PHASE_11L_PROJECT_CONTROLS_COST_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_CHANGE_TABLES = PHASE_11L_PROJECT_CONTROLS_CHANGE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_PROGRESS_TABLES = PHASE_11L_PROJECT_CONTROLS_PROGRESS_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_SCHEDULE_TABLES = PHASE_11L_PROJECT_CONTROLS_SCHEDULE_TABLES;
export const PHASE_11F_PROJECT_CONTROLS_SHARED_PROJECT_TABLES =
  PHASE_11L_PROJECT_CONTROLS_SHARED_PROJECT_TABLES;
