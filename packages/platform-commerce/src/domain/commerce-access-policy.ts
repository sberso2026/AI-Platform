...
export const ENGINEERING_API_POLICIES: Record<string, CommerceAccessPolicy> = {
  ...
  "asset-intelligence-condition.read": {
    productKey: ENGINEERING_PRODUCT,
    applicationKey: "asset_intelligence",
    action: "access",
    seatRequired: true,
  ...
  "asset-intelligence-condition.write": {
    productKey: ENGINEERING_PRODUCT,
    applicationKey: "asset_intelligence",
    action: "access",
    seatRequired: true,
  ...
  "asset-intelligence-health.read": {
    productKey: ENGINEERING_PRODUCT,
    applicationKey: "asset_intelligence",
    action: "access",
    seatRequired: true,
  ...
  "asset-intelligence-asset-snapshot.read": {
    productKey: ENGINEERING_PRODUCT,
    applicationKey: "asset_intelligence",
    action: "access",
    seatRequired: true,
  ...
  "digital-twin-workspace-snapshot.read": {
    productKey: ENGINEERING_PRODUCT,
    applicationKey: "digital_twin",
    action: "access",
    seatRequired: true,
  ...
  "digital-twin-twin-snapshot.read": {
    productKey: ENGINEERING_PRODUCT,
    applicationKey: "digital_twin",
    action: "access",
    seatRequired: true,
  ...
  "model-interoperability-workspace-snapshot.read": {
    productKey: ENGINEERING_PRODUCT,
    applicationKey: "engineering_model_interoperability",
    action: "engineering_model.read",
    seatRequired: true,
...
export const ENGINEERING_PAGE_POLICIES: Record<string, CommerceAccessPolicy> = {
  ...
  "/engineering/my": { productKey: ENGINEERING_PRODUCT, action: "access", seatRequired: true },
