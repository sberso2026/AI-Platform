...
describe("BOS BUSINESS_API_POLICIES", () => {
  it("binds foundation and owner-command routes to business-os and business_os", () => {
    ...
    expect(getBusinessApiPolicy("growth", "GET").workspaceRequired).toBe(true);
    expect(getBusinessApiPolicy("growth", "POST").cachePolicy).toBe("fresh");
    expect(getBusinessApiPolicy("revenue", "GET").workspaceRequired).toBe(true);
    expect(getBusinessApiPolicy("revenue", "POST").cachePolicy).toBe("fresh");
    expect(getBusinessApiPolicy("customers", "GET").workspaceRequired).toBe(true);
    ...
    expect(BUSINESS_PAGE_POLICIES["/business/context"]?.productKey).toBe("business-os");
    expect(BUSINESS_PAGE_POLICIES["/business/ai-workforce"]?.productKey).toBe("business-os");
    expect(BUSINESS_PAGE_POLICIES["/business/integrations"]?.productKey).toBe("business-os");
