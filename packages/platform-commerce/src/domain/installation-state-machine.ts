...
const PRODUCT_TRANSITIONS: Record<ProductInstallationStatus, ProductInstallationStatus[]> = {
  ...
  active: ["degraded", "suspended", "upgrade_pending", "uninstall_pending", "rollback_pending"],
  degraded: ["active", "suspended", "failed", "uninstall_pending", "rollback_pending"],
...
const PRODUCT_EVENTS: Partial<Record<string, string>> = {
  ...
  "active→rollback_pending": "installation.rollback_requested",
