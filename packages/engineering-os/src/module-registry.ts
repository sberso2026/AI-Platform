...
export const ENGINEERING_MODULE_REGISTRATIONS: EngineeringModuleRegistration[] = [
  ...
  },
  {
    ...
    commerceApplicationKey: "asset_intelligence",
    name: "Asset Intelligence",
    description:
      "Asset condition, criticality, reliability, and advisory predictive governance — V1.0 GA",
    version: "1.0.0",
    operatingSystemId: OS_ID,
    status: "registered",
    enabled: true,
    ...
    routes: [
      {
        path: "/engineering/apps/asset-intelligence",
        title: "Asset Intelligence",
        component: "AssetIntelligenceHome",
      },
      {
        path: "/engineering/apps/asset-intelligence/release",
        title: "Asset Intelligence Release",
        component: "AssetIntelligenceRelease",
      },
    ],
    navigation: [
      {
        id: "module-asset-intelligence",
    ...
    permissions: [{ resource: "engineering", action: "read" }],
    searchProviders: ["asset_intelligence.state"],
    aiCapabilities: ["asset_intelligence.advisory"],
    eventHandlers: ["asset_intelligence.*"],
  },
  {
    id: "project_controls",
    ...
    description:
      "Governed cost, schedule, progress, and controls intelligence — V1.0 GA",
    version: "1.0.0",
    operatingSystemId: OS_ID,
    status: "registered",
    enabled: true,
    ...
    routes: [
      ...
      {
        path: "/engineering/apps/project-controls/release",
        title: "Project Controls Release",
        component: "ProjectControlsRelease",
      },
    ],
    navigation: [
      {
    ...
    permissions: [{ resource: "engineering", action: "read" }],
    searchProviders: ["project_controls.progress", "project_controls.intelligence"],
  ...
  },
  {
    ...
    name: "Digital Twin",
    description:
      "Twin identity, state, simulation, and digital thread — V1.0 GA (bounded)",
    version: "1.0.0",
    operatingSystemId: OS_ID,
    status: "registered",
    enabled: true,
    ...
    routes: [
      ...
      {
        path: "/engineering/apps/digital-twin/release",
        title: "Digital Twin Release",
        component: "DigitalTwinRelease",
      },
    ],
    navigation: [
      {
    ...
    searchProviders: ["digital_twin.assets", "digital_twin.twins"],
  ...
  },
  {
    ...
    commerceApplicationKey: "engineering_model_interoperability",
    ...
    routes: [
      {
        path: "/engineering/apps/model-interoperability",
        title: "Engineering Model Interoperability",
        component: "EngineeringModelInteroperabilityHome",
      },
      {
        path: "/engineering/apps/model-interoperability/release",
        title: "Interoperability Release",
        component: "EngineeringModelInteroperabilityRelease",
      },
    ],
    navigation: [
      {
        id: "module-engineering-model-interoperability",
    ...
    permissions: [{ resource: "engineering", action: "read" }],
    searchProviders: [
      "engineering_model_interoperability.models",
      "engineering_model_interoperability.results",
    ],
    aiCapabilities: ["engineering_model_interoperability.federation"],
    eventHandlers: ["engineering_model_interoperability.*"],
  },
];
...
export function buildEngineeringOsManifest(
  ...
  return {
    ...
    routes: [
      { path: "/engineering", title: "Engineering Home", component: "EngineeringHome" },
      ...
      { path: "/engineering/settings", title: "Administration", component: "EngineeringSettings" },
