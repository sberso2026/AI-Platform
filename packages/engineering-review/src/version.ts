export const ENGINEERING_REVIEW_VERSION = "0.6.0-era-6" as const;
export const ENGINEERING_REVIEW_ENGINE_VERSION = "review-engine/0.6.0-era-6" as const;
export const ENGINEERING_REVIEW_PHASE = "ERA-6" as const;
