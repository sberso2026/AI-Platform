/**
 * Lightweight secret exposure scan for Engineering Model Interoperability discovery.
 */
...
const SCAN_ROOTS = [
  resolve(root, "packages/engineering-model-interoperability"),
  resolve(root, "packages/engineering-model-interoperability-certification"),
];
