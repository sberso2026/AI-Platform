...
const SCAN_DOCS = [
  ...
  "docs/security/RTB_PRIVILEGED_MFA_AND_BREAK_GLASS.md",
  "docs/security/RTB_DEPENDENCY_SCA_POLICY.md",
  "docs/security/RTB_UNIFIED_INCIDENT_RESPONSE.md",
  "docs/security/RTB_SECRET_LIFECYCLE_AND_ROTATION.md",
  "docs/security/RTB_CLASSIFICATION_AWARE_AI_AND_LOGGING.md",
  "docs/security/RTB_PLATFORM_BACKUP_RESTORE_RUNBOOK.md",
  "docs/operations/RTB_SECURITY_INCIDENT_RUNBOOK.md",
