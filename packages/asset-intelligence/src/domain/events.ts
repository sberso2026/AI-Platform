...
/**
 * Phase 10K — authoritative enumeration of every V1.0 event name. Frozen public
 * event families in domain/event-contracts.ts are validated against this list.
 */
export const ASSET_INTELLIGENCE_EVENTS = [
  "engineering.asset.condition.updated",
  "engineering.asset.criticality.updated",
  "engineering.asset.criticality.reviewed",
  "engineering.asset.reliability.assessed",
