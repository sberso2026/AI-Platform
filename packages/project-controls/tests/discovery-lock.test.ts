...
describe("Phase 11E Project Controls ownership and forbid locks", () => {
  ...
  it("exposes a coherent declaration", () => {
    ...
    expect(declaration.hierarchy).toContain(
      "progress + schedule + change + cost + productivity + forecast + decision support + scenario + risk/opportunity + assurance + explainability + organizational learning intelligence",
    );
