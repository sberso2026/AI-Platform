...
describe("Phase 11E Project Controls ownership and forbid locks", () => {
  it("declares the productivity intelligence module identity", () => {
    expect(PROJECT_CONTROLS_PRODUCT_NAME).toBe("Project Controls");
    expect(PROJECT_CONTROLS_MODULE_KEY).toBe("project_controls");
    expect(PROJECT_CONTROLS_VERSION).toBe("0.6.0-productivity-intelligence");
    expect(PROJECT_CONTROLS_STATUS).toBe("productivity_intelligence");
    expect(PROJECT_CONTROLS_PHASE).toBe("11F");
  ...
  it("exposes a coherent declaration", () => {
    ...
    expect(declaration.version).toBe("0.6.0-productivity-intelligence");
    expect(declaration.status).toBe("productivity_intelligence");
    expect(declaration.phase).toBe("11F");
