...
Status: ga · Module version: `1.0.0` · Phase: 11N (closes 11M baseline `0.13.0-organizational-learning`)
...
flowchart TB
  ...
  PC["Project Controls 0.13.0-organizational-learning<br/>progress + schedule + change + cost + productivity + forecast + decision support + scenario + risk/opportunity + assurance + explainability + organizational learning intelligence ABOUT projects<br/>composition layer · contingency · earned value reserved"]
