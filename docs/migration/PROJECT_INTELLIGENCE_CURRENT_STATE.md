...
5. **Meeting Intelligence vs Project Intelligence** — AI Platform registry has both `meeting_intelligence` and `project_intelligence`; confirm whether meetings stay under PI or become a sibling app.  
