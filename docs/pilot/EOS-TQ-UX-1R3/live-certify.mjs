/**
 * EOS-TQ-UX-1R3 Live Regression
 * Target: https://rtb-ai-platform-hz4jerb1p-rtbea.vercel.app
...
const host = "https://rtb-ai-platform-hz4jerb1p-rtbea.vercel.app";
const email = "silvestre.berso@rtbea.com.au";
const PROJECT_REF = "wcydlhqiqdwgoaqrlget";
const OUT = resolve("docs/pilot/EOS-TQ-UX-1R3");
...
const report = {
  FINAL_SHA: "18c652dbfee7cf7f37cd77335dae35cef3b4407d",
  PREVIEW_DEPLOYMENT_ID: "dpl_AfEN7J2KaRqzmSe1bZTvTgXgMCXs",
